<script setup>
    ...
    // onMounted(async () => {
    //   try {
    //     const response = await this.$axios.get('/api/inactive-doctors');
    //     inactiveDoctors.value = response.data.inactiveDoctors;
    //   } catch (error) {
        ...
        <div class="px-2 mt-5">
            <div class="p-4 mx-2">
                <div class="flex justify-between">
                    <div class="flex">
                        <button @click="openInactiveDoctorsModal" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-2 mr-4">View Inactive Doctors</button>
                    </div>
                    <Modal :show="showConfirm" @close="closeModal">
                        <div class="p-4 sm:p-10 w-full text-center overflow-y-auto">
                            <table class="min-w-max w-full table-auto">
                                ...
                                <tbody class="text-gray-600 text-sm font-light" >
                                    ...
                                    <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="doc in inactiveDoctors" :key="doc.id">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex items-center justify-center">
                                                <p class="font-medium">
                                                    <span class=" remarks-cell bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">{{ getStatusText(doc.status) }}</span>
                                                </p>
                                            </div>
                                        </td>
                                        <td class="py-3 px-6 text-center">
                                ...
                                <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="doc in doctors" :key="doc.id">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                                <a href="#" class="btn" @click="edit(doc)">
