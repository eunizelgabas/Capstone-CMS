<script setup>
    ...
    const addMedicineToList = () => {
      // Validate the form fields (you can add more validation logic here)
    //   if (!form.value.med_id || !form.value.qty || !form.value.expiry_date) {
    //     alert('Please fill in all fields.');
    //     return;
    //   }

      // Push the form data to the medicineList
      medicineList.value.push({
        med_id: form.value.med_id,
        qty: form.value.qty,
