              ...
              <table class="w-full h-auto table-fixed">
                ...
                <tbody>
                  ...
                  <tr v-for="appointment in appointments" :key="appointment.id" class="border border-gray-300">
                    ...
                    <td class="p-2 border border-gray-300 text-gray-500">{{ appointment.date }}</td>
                    <td class="p-2 border border-gray-300 text-center text-gray-500">{{ appointment.time }}</td>
